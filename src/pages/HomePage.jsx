...
const HomePage = () => {
  return (
    <motion.div
      ...
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}>
      <div className=" h-[50vh] md:h-full md:w-1/2 flex justify-center items-center bg-secondaryDark shadow-2xl md:rounded-r md:pt-16">
      ...
      <div className="md:h-full h-[50vh] md:w-1/2 md:flex md:justify-center md:items-center pt-8 bg-gray-100 flex-col md:pr-20">
        <div className=" md:w-min md:h-min">
          <h1 className="  md:text-[65px] md:leading-[70px]  font-primary tracking-wider  text-secondaryDark font-semibold">
            Bintang
          </h1>
          <h1 className="  md:text-[65px] md:leading-[70px]  font-primary tracking-wider  text-secondaryDark font-semibold">
            Aldiansyah.
          </h1>
          <div className=" w-full mt-4 border-t-2 border-secondaryDark"></div>
